parcelRequire = function(e, r, t, n) {
    ...
    "XX42": [function(require, module, exports) {
        ...
        function u(n) {
            ...
            // Modified: Use container dimensions instead of window dimensions.
            var container = document.querySelector('.projekte_gallery_cms-wrapper');
            l.setSize(container ? container.offsetWidth : window.innerWidth, container ? container.offsetHeight : window.innerHeight);
            l.setPixelRatio(window.devicePixelRatio);
            this.options = a, this.render = this.render.bind(this), this.textures = n.map(function(e, t) {
        ...
        u.prototype.getViewSize = function() {
            ...
            var e = this.getPlaneSize(),
                ...
                u = new o.ShaderMaterial({
                    uniforms: {
                        ...
                        // Modified: Use container dimensions for resolution and rgb position.
                        u_resolution: {
                            type: "v2",
                            value: (function() {
                                var container = document.querySelector('.projekte_gallery_cms-wrapper');
                                return new s.Vector2(container ? container.offsetWidth : window.innerWidth, container ? container.offsetHeight : window.innerHeight);
                            })()
                        },
                        u_rgbPosition: {
                            type: "v2",
                            value: (function() {
                                var container = document.querySelector('.projekte_gallery_cms-wrapper');
                                return new s.Vector2(container ? container.offsetWidth / 2 : window.innerWidth / 2, container ? container.offsetHeight / 2 : window.innerHeight / 2);
                            })()
                        },
                        u_rgbVelocity: {
                            type: "v2",
            ...
            // Modified: Use container dimensions on resize.
            var container = document.querySelector('.projekte_gallery_cms-wrapper');
            this.renderer.setSize(container ? container.offsetWidth : window.innerWidth, container ? container.offsetHeight : window.innerHeight);
            this.mesh.material.uniforms.u_resolution.value = new s.Vector2(container ? container.offsetWidth : window.innerWidth, container ? container.offsetHeight : window.innerHeight);
            for (var e = 0; e < this.textures.length; e++) 
                this.textures[e].image && this.calculateAspectRatioFactor(e, this.textures[e]);
            this.render()
